    ...
    return <section id="hero" className="d-flex justify-content-center align-items-center">
                <div className="card">
                    ...
                    <div className="text-center font-20px" style={{maxWidth: "720px"}}>  
                        <p>
                            <span style={{ fontSize: "28px" }}>Hi there!</span> I'm Kyle Rego, a self-taught software developer on a quest to create great software. I love problem-solving, building applications, learning about new things, and contributing to the community.
                        </p>
